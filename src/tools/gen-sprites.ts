...
const CHARS: Char[] = [
  ...
  { id: 'MEN', brief: 'a flashy rival fighter — bright BLUE karate gi with a white belt hanging open over a muscular chest, spiky BLOND hair, barefoot', build: 'a POWERFULLY built, heavily muscled fighter — broad shoulders, thick muscular arms and legs, a wide chest; stocky, beefy and imposing yet athletic; about 6.5 heads tall with big obvious muscles' },
  ...
  { id: 'CHONG', brief: 'an agile kick specialist — PURPLE sleeveless fighting dress with gold trim, dark hair in two buns, powerful legs', build: 'a STRONG, muscular, athletic fighter — powerful thick thighs and calves, toned muscular arms and broad strong shoulders; about 6.5 heads tall, muscular and beefy yet agile' },
